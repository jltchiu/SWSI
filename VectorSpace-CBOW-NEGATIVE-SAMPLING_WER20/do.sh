...
FILES=/usr1/jchiu1/Thesis/Interspeech/VectorSpace-CBOW-NEGATIVE-SAMPLING_WER20/Step1-mat_for_CLUTO/*.mat
for f in $FILES
do
...
FILES=/usr1/jchiu1/Thesis/Interspeech/VectorSpace-CBOW-NEGATIVE-SAMPLING_WER20/Step1-mat_for_CLUTO/*.sentence.mat
for f in $FILES
do
  file_name=$(basename $f)

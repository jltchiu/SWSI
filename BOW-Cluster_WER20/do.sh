...
FILES=/usr1/jchiu1/Thesis/Interspeech/BOW-Cluster_WER20/Step-1-TxtforCLUTO/*.txt
for f in $FILES
do
...
FILES=/usr1/jchiu1/Thesis/Interspeech/BOW-Cluster_WER20/Step-2-matforCLUTO/*.mat
for f in $FILES
do
  file_name=$(basename $f)
...
FILES=/usr1/jchiu1/Thesis/Interspeech/BOW-Cluster_WER20/Step-2-matforCLUTO/*.sentence.mat
for f in $FILES
do
  file_name=$(basename $f)
